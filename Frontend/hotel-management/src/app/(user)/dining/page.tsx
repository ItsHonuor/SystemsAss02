...
const menus = [
    { title: "Breakfast", hours: "07:00 — 11:00", highlight: "Truffle Eggs Benedict", img: "https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?auto=format&fit=crop&q=80&w=800" },
    { title: "Lunch", hours: "12:30 — 15:30", highlight: "Seared Bluefin Tuna", img: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&q=80&w=800" },
    { title: "Dinner", hours: "18:30 — 22:30", highlight: "Wagyu A5 Filet", img: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?auto=format&fit=crop&q=80&w=800" },
];
        ...
        <div className="min-h-screen bg-[#FBFBFD] text-[#1d1d1f] antialiased" 
            ...
            <section className="max-w-[1400px] mx-auto px-6 py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {menus.map((item) => (
                        <div key={item.title} className="group relative bg-white rounded-[40px] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-700">
                            ...
                            <div className="p-10">
                                ...
                                <button className="w-full py-4 rounded-2xl border border-gray-100 font-bold text-[11px] uppercase tracking-widest hover:bg-black hover:text-white transition-all">
                                    View Menu
                                </button>
                            </div>
                        </div>

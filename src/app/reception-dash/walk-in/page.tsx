...
export default function WalkInPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (res.ok) {
                router.push("/reception-dash/bookings");
            } else {
        ...
        <div className="p-8 max-w-2xl">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
                ...
                {nights > 0 && selectedRoom && (
                    <div className="bg-purple-50 border border-purple-100 rounded-xl px-4 py-4 space-y-2">
                        ...
                        <div className="flex justify-between font-bold text-purple-800 border-t border-purple-200 pt-2 mt-1">
                            <span>Total</span>
                ...
                <div className="flex gap-3 justify-end pt-2">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold px-6 py-2.5 rounded-xl text-sm transition-colors disabled:opacity-50"
                    >
                        <CheckCircle2 size={16} />
                        {loading ? "Creating..." : "Check In Guest"}
                    </button>
                </div>
            </div>
        </div>
